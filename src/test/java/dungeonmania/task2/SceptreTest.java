...
public class SceptreTest {
    ...
    public void sceptreRecipes() {
        ...
        // Case1: Pick up 1 wood, 1 treasure, 1 sunstone
        ...
        // Case2: Pick up 1 wood, 1 key, 1 sunstone
        ...
        // Case3: Pick up 2 arrows, 1 treasure, 1 sunstone
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.RIGHT);
        res = dmc.tick(Direction.RIGHT);
        res = dmc.tick(Direction.RIGHT);
        ...
        // Case4: Pick up 2 arrows, 1 key, 1 sunstone
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.LEFT);
        ...
        // Case5: Pick up 2 arrows, 2 sunstones
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.RIGHT);
        res = dmc.tick(Direction.RIGHT);
        res = dmc.tick(Direction.RIGHT);
        ...
        // Case6: Pick up 1 wood, 2 sunstones
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.LEFT);
        assertEquals(1, TestUtils.getInventory(res, "wood").size());
        ...
        // Case7: uncraftable: Pick up 1 sunstone, 1 wood (test they uncraftable)
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.RIGHT);
        assertEquals(1, TestUtils.getInventory(res, "wood").size());
        assertEquals(1, TestUtils.getInventory(res, "sunstone").size());
