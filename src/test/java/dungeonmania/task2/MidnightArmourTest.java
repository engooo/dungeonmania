...
public class MidnightArmourTest {
  ...
  public void testMidnightArmourBuffs() throws IllegalArgumentException, InvalidActionException {
    ...
    DungeonResponse res = controller.newGame("d_midnightArmourTest_MidnightArmourBuffs", config);
    ...
    assertEquals(1, TestUtils.countEntityOfType(entities, "sun_stone"));
    ...
    double midnightDefenceBonus = Double
        .parseDouble(TestUtils.getValueFromConfigFile("midnight_armour_defence", config));
